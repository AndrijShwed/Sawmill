...
namespace Sawmill.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(
            ...
            SignInManager<IdentityUser> signInManager/*, Number numbers*/)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.PhoneNumber != phoneNumber)
            {
                ...
                {
                    StatusMessage = "Помилка при спробі встановити номер телефону.";
